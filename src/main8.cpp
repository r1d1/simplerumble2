...
int main(int argc, char** argv)
{
    ...
    sf::Text titleText;
    std::string titleString = "SIMPLE RUMBLE 2 !\n\t\t\t\tv" + std::to_string(Simplerumblelive_VERSION_MAJOR) + "." +  std::to_string(Simplerumblelive_VERSION_MINOR);
    std::cout << "SIMPLE RUMBLE 2 ! v" << Simplerumblelive_VERSION_MAJOR << "." << Simplerumblelive_VERSION_MINOR << std::endl;
    ...
    Attack attackOne("Blade", attackTypes.at(0), 4);
    Attack attackTwo("Blade", attackTypes.at(1), 3);
    Attack attackThree("Blade", attackTypes.at(2), 4);
    ...
    // Forcing characters and sprites for developing the live version
    player = &character1;
    opponent = &character2;
    playerSprite = &character1Sprite;
    opponentSprite = &character2Sprite;
    ...
    sf::Clock clock;
    player->changeAttack(&attackOne);
    opponent->changeAttack(&attackThree);
                ...
                switch(gameState)
                {
                    ...
                    case 2 :
                        ...
                        else
                        {
                            ...
                            {
                                sf::Vector2f p1 = playerSprite->getPosition();
                                sf::Vector2f p2 = opponentSprite->getPosition();
